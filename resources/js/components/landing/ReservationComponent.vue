<template>
    <div class="p-32 bg-[#F8F9FB] flex flex-col gap-14">
        <div>
            <h1
        ...
        <div class="flex flex-col gap-4">
            <div class="relative flex items-center">
                ...
                <div class="flex absolute right-3 items-center gap-5">
                    ...
                    >
                        <p class="text-base text-white uppercase">Rechercher</p>
                    </button>
                </div>
            </div>
            <div
            ...
            >
                ...
                <div class="flex flex-col gap-2 justify-center ps-20">
                    ...
                    >
                        <p class="text-white uppercase text-sm">Filtrer</p>
                    </button>
                    <p
            ...
            <div class="grid grid-cols-4 gap-14">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <div class="flex auto-rows-max gap-5">
                        <!-- Google -->
                        <section>
                            <div
                        ...
                        <section>
                            <div
                                class="flex flex-col justify-center gap-2 bg-white p-4 rounded-lg shadow-md h-full"
                            >
                                <label
                                ...
                                <p class="text-[0.6rem]">
                                    TrustScore
                                    <span class="font-bold text-[0.6rem]"
                                        >4.7 | 8.085</span
                                    >
                                    avis
                                </p>
                    ...
                    <div class="relative w-full h-40 rounded-xl shadow-md">
                        <img
