<template>
    ...
    >
        ...
        <div class="lg:py-10">
            <div class="flex flex-col pb-0 lg:pb-[5.5rem] gap-10 lg:gap-5">
                <div class="shadow-md lg:shadow-none">
                    <custom-container>
                        <div
                            class="py-5 w-full flex justify-center lg:justify-start"
                        >
                ...
                <custom-container>
                    <div class="grid grid-cols-1 lg:grid-cols-2 :gap-5">
                                            ...
                                            >
                                                ...
                                                >
                                                    <i
                                                        ...
                                                        "
                                                        :class="[
                                                            'inline-flex justify-center items-center p-[0.2rem] text-white',
                                                            index === 4
                                                                ? 'bg-half-gradient'
                                                                : 'bg-green-500',
                                                        ]"
                        ...
                        <section class="py-20 lg:py-0">
                            <div
                                class="relative h-full py-16 lg:py-0 px-16 flex justify-center"
                            >
                                <div
                                ...
                                <!-- <div
                                    ...
                                    ></div> -->
                                <div
                                    class="absolute -top-[40%] right-[5%] lg:-top-[90%] lg:-right-[45%] h-full w-[67.5rem] lg:w-[70rem] text-accent-500"
                                >
                                    <video-shape />
                                </div>
                            </div>
