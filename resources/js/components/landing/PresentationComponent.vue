<template>
    <div class="relative text-dark-500 overflow-hidden bg-[#f8f9fg] shadow-md">
        <div class="block h-[0.625rem] bg-accent-500 w-full"></div>
        <custom-container>
            <div class="relative py-[5.5rem] z-10">
                    ...
                    <div class="grid grid-cols-2 gap-5">
                        ...
                        <section>
                            <div class="flex flex-col gap-10">
                                ...
                                <div class="flex flex-col gap-[11px] ms-4">
                                    <label
                        ...
                        <section class="z-10">
                            <div class="px-16">
                                <div
                                    class="h-[20rem] w-[35rem] rounded-md shadow"
                                >
                                    <iframe
                                        :src="
                                            handleVideo(
        ...
        <div
            class="absolute -top-[12rem] left-1/2 w-[60rem] h-[55rem] rounded-full bg-accent-500 shadow"
        ></div>
    </div>
</template>
<script>
